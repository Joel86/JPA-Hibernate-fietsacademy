...
public class ZoekenServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getQueryString() != null) {
			...
			if(StringUtils.isLong(id)) {
				docentService.read(Long.parseLong(id)).ifPresent(
						docent -> request.setAttribute("docent", docent));
			} else {
	...
	private void bijnamenVerwijderen(HttpServletRequest request, HttpServletResponse response,
